  ...
  return (
    <div className="min-h-screen bg-[#111b21] flex flex-col items-center justify-center px-4">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-[#8696a0] text-sm mt-1">Simple. Reliable. Private.</p>
      </div>

      <div className="bg-[#202c33] rounded-2xl p-8 w-full max-w-sm shadow-2xl">
        <h2 className="text-[#e9edef] text-xl font-semibold mb-1">Welcome back</h2>
        <p className="text-[#8696a0] text-sm mb-6">Sign in to continue</p>
        ...
        <p className="text-[#8696a0] text-sm text-center mt-5">
          ...
          <Link href="/signup" className="text-[#25D366] hover:underline font-medium">Create one</Link>
        </p>
      </div>
    </div>
  );
